...
export function RegisterPage() {
        ...
        >
          ...
          <Link to="/auth/login">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="px-8 py-3 bg-gray-900 text-white rounded-xl font-medium hover:bg-rose-600 transition-colors"
            >
              {t('auth.login')}
            </motion.button>
          </Link>
  ...
  return (
    <div className="min-h-screen pt-20 flex items-center justify-center bg-gradient-to-br from-rose-50 via-white to-amber-50 px-4 py-8">
      <motion.div
      ...
      >
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <p className="mt-6 text-center text-gray-600">
            ...
            <Link to="/auth/login" className="text-rose-600 hover:underline font-medium">
              {t('auth.login')}
            </Link>
          </p>
        </div>
